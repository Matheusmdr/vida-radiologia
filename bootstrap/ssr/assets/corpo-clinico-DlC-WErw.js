...
function Page({ clinicalStaff }) {
  const sortClinicalStaffAlphabetically = (staffList) => {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "space-y-10 bg-[#EEEEEE] py-10 md:space-y-20 md:py-20", children: [
      /* @__PURE__ */ jsxs("section", { className: "space-y-10 md:space-y-20", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mx-auto grid w-3/5 max-w-7xl grid-cols-1 place-items-center items-center justify-center justify-items-center gap-6 sm:w-4/5 md:grid-cols-2 md:gap-12", children: sortedStaff.map((staff, i) => {
          var _a;
