...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./pages/${name}.tsx`,
      /* @__PURE__ */ Object.assign({ "./pages/admin/clinical-staff/create.tsx": () => import("./assets/create-BORhhQqx.js"), "./pages/admin/clinical-staff/edit.tsx": () => import("./assets/edit-DRLh1Da6.js"), "./pages/admin/clinical-staff/index.tsx": () => import("./assets/index-CczeYfJd.js"), "./pages/admin/exams/create.tsx": () => import("./assets/create-DI6bUx1H.js"), "./pages/admin/exams/edit.tsx": () => import("./assets/edit-DnKjQSI0.js"), "./pages/admin/exams/index.tsx": () => import("./assets/index-BUTUjDIB.js"), "./pages/admin/exams/subexams/create.tsx": () => import("./assets/create-Cs45gJf4.js"), "./pages/admin/exams/subexams/edit.tsx": () => import("./assets/edit-Du5lc4Lt.js"), "./pages/admin/exams/subexams/index.tsx": () => import("./assets/index-B0FIVHMs.js"), "./pages/admin/index.tsx": () => import("./assets/index-CLaxvdpa.js"), "./pages/admin/units/create.tsx": () => import("./assets/create-Dqi530rR.js"), "./pages/admin/units/edit.tsx": () => import("./assets/edit-D1zffk-M.js"), "./pages/admin/units/index.tsx": () => import("./assets/index-Cj2wNg4T.js"), "./pages/admin/users/create.tsx": () => import("./assets/create-CkG4MoQN.js"), "./pages/admin/users/edit.tsx": () => import("./assets/edit-QFqxVvSo.js"), "./pages/admin/users/index.tsx": () => import("./assets/index-DfPk56bh.js"), "./pages/auth/login.tsx": () => import("./assets/login-D4OPde2n.js"), "./pages/convenios.tsx": () => import("./assets/convenios-Ca35zSg6.js"), "./pages/corpo-clinico.tsx": () => import("./assets/corpo-clinico-D8hLaYuj.js"), "./pages/exames/exame/index.tsx": () => import("./assets/index-CosMLA9X.js"), "./pages/exames/index.tsx": () => import("./assets/index-D4Zn7XdF.js"), "./pages/index.tsx": () => import("./assets/index-B730UzcV.js"), "./pages/unidades.tsx": () => import("./assets/unidades-C96MbtVY.js") })
    ),
    setup: ({ App, props }) => {
